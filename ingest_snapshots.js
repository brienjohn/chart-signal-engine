...
const SOURCES = [
  ...
  },
  {
    ...
    parseRow: (r) => ({
      ...
      metrics: { market: r.market, rank_change: r.rank_change, spotify_artist_id: r.artist_spotify_id, image_url: r.image_url || "" },
    }),
  },
  {
    ...
    parseRow: (r) => ({
      ...
      track_name: r.track_name || "",
      captured_at: toEpoch(r.captured_date),
      metrics: { genre: r.genre, chart_type: r.chart_type, kkbox_artist_id: r.artist_id, kkbox_track_id: r.track_id, image_url: r.image_url || "" },
    }),
  },
  {
    source: "kkbox_kma",
  ...
  },
  {
    ...
    parseRow: (r) => ({
      ...
      captured_at: toEpoch(r.captured_date),
      metrics: { market: r.market, release_date: r.release_date, metric_value: r.metric_value, raw_text: r.raw_text, image_url: r.image_url || "", video_url: r.video_url || "" },
    }),
  },
];
